...
BEAN_HEIGHT	= 0.5	# Size of the character
CURVE_JUMP_UP= curve.linear  # easing curve for bean "jump" when switching attachment
CURVE_JUMP_DOWN=curve.linear   # easing curve for bean "fall" when switching attachment
